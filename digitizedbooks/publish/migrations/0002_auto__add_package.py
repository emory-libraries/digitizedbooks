...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'publish_kdip', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kdip_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='new', max_length=20)),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publish.Job'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'publish.kdip': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['publish.Job']", 'null': 'True', 'blank': 'True'}),
            'kdip_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
