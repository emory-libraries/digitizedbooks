...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ValidationErrors'
        db.delete_table(u'publish_validationerrors')

        # Adding model 'ValidationError'
        db.create_table(u'publish_validationerror', (
        ...
        db.send_create_signal(u'publish', ['ValidationError'])


    def backwards(self, orm):
        # Adding model 'ValidationErrors'
        db.create_table(u'publish_validationerrors', (
            ('error_type', self.gf('django.db.models.fields.CharField')(max_length=25)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kdip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publish.KDip'])),
            ('error', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'publish', ['ValidationErrors'])

        # Deleting model 'ValidationError'
        db.delete_table(u'publish_validationerror')
    ...
    models = {
        ...
        u'publish.validationerror': {
            'Meta': {'object_name': 'ValidationError'},
